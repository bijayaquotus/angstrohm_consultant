  ...
  return (
    <section ref={sectionRef} className="bg-[#0c0b2e] py-16 md:py-20 px-6 overflow-hidden relative">
      ...
      <div className="max-w-[1280px] mx-auto relative z-10">
        ...
        {/* Container with flex wrap and gap */}
            ...
            return (
              ...
              >
                ...
                <div 
                  ...
                  className="icon-wrapper w-14 h-14 rounded-md border border-[#3b4a8f]/60 bg-[#161544] flex items-center justify-center mb-5 shrink-0 relative transition-all duration-300"
                >
                  {/* Icon background glow */}
                  <div className="absolute inset-0 rounded-md bg-[#5fb8e0]/10 blur-sm" />
