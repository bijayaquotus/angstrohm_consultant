          ...
          {items.map((item, i) => {
            ...
            return (
              <div 
                ...
                className="w-full md:w-[calc(33.333%-1.35rem)] min-w-[280px] max-w-[380px] bg-[#161544]/60 border border-[#3b4a8f]/40 p-6 md:p-8 rounded-xl shadow-lg transition-all duration-300 flex flex-col items-start relative cursor-pointer group"
              >
                {/* Card glow effect */}
                ...
                <div 
                  ...
                  className="icon-wrapper w-14 h-14 rounded-lg border border-[#3b4a8f]/60 bg-[#161544] flex items-center justify-center mb-5 shrink-0 relative"
                >
                ...
                {/* Card Title */}
                <h3 className="text-[#c8385a] font-bold text-sm tracking-wide uppercase mb-3 relative z-10">
                  {item.title}
                </h3>
