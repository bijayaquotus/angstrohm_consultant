            ...
            return (
              ...
              >
                ...
                <div 
                  ...
                  className="icon-wrapper w-14 h-14 rounded-lg border border-[#3b4a8f]/60 bg-[#161544] flex items-center justify-center mb-6 shrink-0 relative transition-all duration-300"
                >
